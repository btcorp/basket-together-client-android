...
//    protected View mBlackEmptyView;
...
//        mRootView = root;
//        View v = fragment.getActivity().getLayoutInflater().inflate(R.layout.fragment_camera_view, mRootView);
//        mParentCameraPreview = (ViewGroup) v.findViewById(R.id.layout_camera_view);
//        mBlackEmptyView = mParentCameraPreview.findViewById(R.id.empty_black_view);
...
//        if (BuildUtil.isGoogleReferencePhoneLollipop()) {
...
//            mBtnSwitchFlash.setImageResource(R.drawable.ic_edit_camera_flash_off);
//        } else if (flashMode == FLASH_MODE_AUTO){
//            mBtnSwitchFlash.setImageResource(R.drawable.ic_edit_camera_flash_auto);
//        } else {
//            mBtnSwitchFlash.setImageResource(R.drawable.ic_edit_camera_flash_on);
//        }
//    }
//
//    @Override
