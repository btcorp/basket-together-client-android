...
public class RecruitAPI {
    public static void getRecruitPostDetail(BaseActivity activity, String postId, final APICallResponseNotifier notifier) {
        new HttpAPIRequester(activity, true, ServerURLInfo.API_GET_RECRUIT_POST_DETAIL + postId + "/", "GET",
                new HttpAPIRequester.DefaultAPICallReponseNotifier(notifier)).execute((JSONObject)null);
    }

    public static void cancelAttendToRecruit(BaseActivity baseActivity, long postId, final APICallResponseNotifier notifier) {
        new HttpAPIRequester(baseActivity, true, String.format(ServerURLInfo.API_RECRUIT_REQUEST_ATTEND_CANCEL, postId), "GET",
                new HttpAPIRequester.DefaultAPICallReponseNotifier(notifier)).execute((JSONObject)null);
    }

    public static void requestAttendToRecruit(BaseActivity baseActivity, long postId, final APICallResponseNotifier notifier) {
        new HttpAPIRequester(baseActivity, true, String.format(ServerURLInfo.API_RECRUIT_REQUEST_ATTEND, postId), "GET",
                new HttpAPIRequester.DefaultAPICallReponseNotifier(notifier)).execute((JSONObject)null);
    }

    public static void getRecruitPostComments(BaseActivity activity, long postId, final APICallResponseNotifier notifier) {
    ...
    public static void registCommentToRecruit(BaseActivity activity, long postId, String content,
                                              final APICallResponseNotifier notifier) throws JSONException{
        ...
        new HttpAPIRequester(activity, true, String.format(ServerURLInfo.API_RECRUIT_POST_REGIST_COMMENT, postId), "POST",
                new HttpAPIRequester.DefaultAPICallReponseNotifier(notifier)).execute(commentData);
    }
    ...
    public static void deleteRecruitPost(BaseActivity activity, long postId, final APICallResponseNotifier notifier) {
    ...
    public static void registRecruitPost(BaseActivity activity, String title, String content, int recruitPeopleNum,
                                         ...
                                         String addr1, String addr2, final APICallResponseNotifier notifier) throws JSONException {
        ...
        new HttpAPIRequester(activity, true, ServerURLInfo.API_RECRUIT_POST_REGIST, "POST",
                new HttpAPIRequester.DefaultAPICallReponseNotifier(notifier)).execute(data);
    }
